...
const BOTNAME = 'Mbots-Gold-MD|-WA-BOT™';
const FOOTERNAME = '> Mbots -  ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '212722055011' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=XRMxHb6I#63wpjO18z362x5uRP61Ui3_CGuiNlIo2eknVvtjMBC8' ,
