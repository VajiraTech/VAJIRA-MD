...
global.owner = process.env.OWNER_NUMBER  || '94775893282' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=PVEkRTZD#F_zpgqxo3NCqLvH1IYgWFFtFntptdyg2LnrUIpg7Eqk' ,
