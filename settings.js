...
global.owner = process.env.OWNER_NUMBER  || '94741839074' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=uE9VXaRZ#Eor36NNzjl8OoDX1FksIS6aZIAVmMrV931k8ArooMU8' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94741839074,94741839074" : process.env.MODERATORS ,    
