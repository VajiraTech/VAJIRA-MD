...
global.owner = process.env.OWNER_NUMBER  || '923266556989' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=3d1hgBTb#HAQuIFnPMtUCfIzEn-Chxsj7UHOg_ozTI4NMqJla_xo' ,
