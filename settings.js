...
global.owner = process.env.OWNER_NUMBER  || '255773816991' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID ||VAJIRA-MD=KZ8l1LrL#aXWMRy79yajSVKKHnXgSr4pWyb68wBAjbkVB5DMOLqc
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'sir noollah' ,
