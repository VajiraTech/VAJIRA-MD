...
global.owner = process.env.OWNER_NUMBER  || '263712196152' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=mJ8D1QzY#UPdHPzXz1TPsbOeThrLptNuZ-rkG7_jRGHWiztnNsc8' ,
...
INBOX_USER: process.env.INBOX_USER === undefined ? 'all' : process.env.INBOX_USER,
