...
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=eJUViQpB#uYGXG0AUQsHB4Y-qJxl2VrDuWMFUvH5tEXuuaa6riS0' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '4650': process.env.MAX_SIZE,/*add this in megabytes*/    
