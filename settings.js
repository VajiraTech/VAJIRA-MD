...
global.owner = process.env.OWNER_NUMBER  || '2349033769727' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=qAEghLhD#2LUX-xfzBsyrzTJybNRyh6wl-z-TB-IATVV6itvxWUE' ,
