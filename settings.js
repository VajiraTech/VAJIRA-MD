...
const BOTNAME = 'A H S A N|-WA-BOT™';
const FOOTERNAME = '> A H S A N ';
global.owner = process.env.OWNER_NUMBER  || '923336181194' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=jQVXWJoK#XAbTsYubmaZ1RSFo9Zaq1zHeHlOq4Bx0Jtdt3NWYUrg' ,
