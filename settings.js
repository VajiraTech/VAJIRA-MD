...
global.owner = process.env.OWNER_NUMBER  || '18763834999' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=nQFFCD5B#rz3ODdfUa8fjdRmRl4FHvPFqa9bLHcf17IjHWEHZ4fs' ,
