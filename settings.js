...
global.owner = process.env.OWNER_NUMBER  || '9203013225976' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'youre session id' ,VAJIRA-MD=uQ8T0TrT#0kpXyy1fV0tsPPr7kizYtBA3XE8bZDV_d6sDOJZ0osw
