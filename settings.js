...
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=nc9BkZyJ#eVIp6h5uTvX1tjNj5NdT2rog0nxIGx33d7C-CxxUYVU' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94787820101" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*300*/    
