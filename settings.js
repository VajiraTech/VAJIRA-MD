...
global.owner = process.env.OWNER_NUMBER  || '94767748006' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=nc1nEDoD#nz6EGo445FsL38X5sezVi8pCymIT_kbQxxFsvZ7_mCA' ,
